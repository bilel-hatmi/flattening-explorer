...
<p class="lead">My Part III essay, on proximal causal inference, is the project that tested me most. It estimates a causal effect when the confounder is unobserved, from two noisy proxies.</p>
...
<blockquote class="pull">The lengthscale remains the one parameter the analyst must anchor externally. The methods are in place. What we need next is to design future studies around them.<br /><small>From the essay's closing section.</small></blockquote>
