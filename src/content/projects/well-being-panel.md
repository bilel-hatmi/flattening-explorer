...
<p class="lead"><strong>My attachment to making AI a tool in the service of human capital was born here</strong>, in a summer research internship at Elements Impact where I modelled well-being mathematically, under Emmanuelle Bioud (PhD, cognitive science).</p>
...
<dl class="work">
<dt>Predictive modelling</dt><dd>I trained, evaluated and selected supervised models on a <strong>20-year longitudinal panel of more than 1,000 individuals</strong>, with feature engineering, cross-validation and sensitivity analyses. The result was an operational prototype.</dd>
