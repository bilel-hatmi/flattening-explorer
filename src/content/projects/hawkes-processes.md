...
The findings were clear-cut. Maximum likelihood with random restarts was the most effective method on clean binned data; when the data were degraded, only the Whittle estimator remained usable. Group project at CentraleSupélec, supervised by Ioane Muni Toke; the technical report is available on request.
