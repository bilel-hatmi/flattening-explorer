...
export const RESEARCH_LINES = [
  ...
  },
  {
    ...
    text: 'The properties that generate constructs such as sycophancy or malice: epistemic validity, procedural validity, direction, directional entropy. Read by two instruments, behaviour and the model’s internals, across five conditions.',
