...
export default function ActD() {
  ...
  return (
    <section style={{ padding: '12px 0' }}>
      <h2 style={{ textAlign: 'center', marginBottom: 14, fontSize: isMobile ? 23 : 28, fontFamily: "'Instrument Serif', serif", color: '#22375A', ...(isMobile ? { padding: '0 8px' } : {}) }}>
        Act IV: The systemic picture
      </h2>
      <D1_Contagion />
      <D2BIS_SupplyChain />
      <D3_GeoMap />
