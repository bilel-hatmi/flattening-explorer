...
export default function ActB() {
  ...
  return (
    <section style={{ padding: '12px 0' }}>
      <h2 style={{ textAlign: 'center', marginBottom: 14, fontSize: 28, fontFamily: "'Instrument Serif', serif", color: '#22375A', ...(isMobile ? { fontSize: 23, marginBottom: 10, padding: '0 12px' } : {}) }}>
        Act II: The mechanisms
      </h2>
      <B1_CorrelationGrid />
      <B2_Convergence />
      <B3_PiFrontier />
