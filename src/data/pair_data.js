...
export const PAIRS = [
  ...
  },
  {
    ...
    right: { profile: 'P8', scenario: 'G0', label: 'Central admin · Seoul' },
    insight: '<strong>Both highest-risk profiles after Bangalore.</strong> Brussels combines maximum outside-frontier exposure with a centralised stack. Seoul combines maximum stack concentration with the most homogeneous recruitment in the model. Both carry premiums above 90%. Neither benefits meaningfully from governance. Structural reform is the only effective lever.',
    category: 'Mixed: interpret with care',
    tier: 2,
    badge: 'orange',
  ...
  },
  {
    ...
    right: { profile: 'P6', scenario: 'G0', label: 'Creative agency · Singapore' },
    insight: '<strong>Both in predominantly inside-frontier domains.</strong> Singapore\u2019s lower tail risk reflects its architectural advantage: a diversified AI stack (\u03B1=0.30) and cosmopolitan recruitment (Beta 1.5) limit correlated errors. San Francisco\u2019s velocity constraint makes governance counterproductive (scaffold benefit \u221236%). Even in AI-friendly domains, stack concentration matters.',
    category: 'Mixed: interpret with care',
    tier: 2,
    badge: 'orange',
  ...
  },
  {
    ...
    left:  { profile: 'P1', scenario: 'G0', label: 'Big Four · Frankfurt' },
    right: { profile: 'P6', scenario: 'G0', label: 'Creative agency · Singapore' },
    insight: '<strong>15% gap between two mid-tier organisations.</strong> Frankfurt\u2019s audit combines moderate stack concentration and homogeneous continental pipeline. Singapore runs a diversified multi-tool stack with international talent. Under governance, Singapore approaches near-zero residual premium; Frankfurt retains a meaningful premium: its stack concentration limits what governance can achieve.',
    category: 'Illustrative: multiple drivers',
    tier: 3,
    badge: 'grey',
    drivers: '\u03B1 + Beta + E[\u03C0] all differ',
  },
  {
    ...
    left:  { profile: 'P2', scenario: 'G0', label: 'Inv. bank · London' },
    right: { profile: 'P7', scenario: 'G0', label: 'Back-office · Bangalore' },
    insight: '<strong>Lowest and near-highest tail risk, 38% gap.</strong> London\u2019s protection: elite talent (h 0.65\u20130.95), diversified stack (\u03B1=0.40), cognitive diversity (Beta 1.5). London also has the highest scaffold benefit in the model (+146%): its existing diversity makes governance maximally effective. Bangalore\u2019s low skill and concentrated stack offer the opposite on every dimension.',
    category: 'Illustrative: multiple drivers',
    tier: 3,
    badge: 'grey',
    drivers: 'h range + \u03B1 + Beta all differ',
  },
  {
    ...
    left:  { profile: 'P2', scenario: 'G0', label: 'Inv. bank · London' },
    right: { profile: 'P4', scenario: 'G0', label: 'Corp. legal · Brussels' },
    insight: '<strong>London\u2019s banking vs Brussels\u2019s legal.</strong> London: elite talent internationally, diversified stack. Brussels: mid-tier talent through a homogeneous pipeline, centralised stack, most challenging AI domain (E[\u03C0]=0.45). The 35% gap represents the compound effect of domain exposure, stack concentration, and cognitive homogeneity: all adverse for Brussels, all favourable for London.',
    category: 'Illustrative: multiple drivers',
    tier: 3,
    badge: 'grey',
    drivers: '\u03B1 + Beta + E[\u03C0] + h range all differ',
