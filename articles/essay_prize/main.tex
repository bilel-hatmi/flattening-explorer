...
$\vcenter{\hbox{\includegraphics[height=1.3cm]{../logo/ucam-logo-colour-preferred.png}}}$ &
$\vcenter{\hbox{\includegraphics[height=1.4cm]{"../logo/CentraleSup Logo H_RVB.png"}}}$ &
$\vcenter{\hbox{\includegraphics[height=1.3cm]{../logo/01_Horizontal.png}}}$
\end{tabular*}
\end{center}
