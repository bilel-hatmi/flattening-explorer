...
\begin{center}
\begin{tabular}{ccc}
\raisebox{0.5cm}{\includegraphics[height=0.9cm]{../logo/ucam-logo-colour-preferred.png}} &
\hspace{1.2cm}\includegraphics[height=2.2cm]{../logo/CentraleSup Logo H_RVB.png}\hspace{1.2cm} &
\raisebox{0.3cm}{\includegraphics[height=1.5cm]{../logo/01_Horizontal.png}}
\end{tabular}
\end{center}
